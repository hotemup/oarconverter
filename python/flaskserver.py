...
def parseXMLFile(file, verbose):
	...
	data['PathBegin'] = root.findtext(".//PathBegin")
	data['PathCurve'] = root.findtext(".//PathCurve")
	data['PathEnd'] = root.findtext(".//PathEnd")
	data['PathRadiusOffset'] = root.findtext(".//PathRadiusOffset")
	data['PathRevolutions'] = root.findtext(".//PathRevolutions")
	data['PathScaleX'] = root.findtext(".//PathScaleX")
	data['PathScaleY'] = root.findtext(".//PathSCaleY")
	data['PathShearX'] = root.findtext(".//PathShearX")
	data['PathShearY'] = root.findtext(".//PathShearY")
	data['PathSkew'] = root.findtext(".//PathSkew")
	data['PathTaperX'] = root.findtext(".//PathTaperX")
	data['PathTaperY'] = root.findtext(".//PathTaperY")
	data['PathTwist'] = root.findtext(".//PathTwist")
	data['PathTwistBegin'] = root.findtext(".//PathTwistBegin")
